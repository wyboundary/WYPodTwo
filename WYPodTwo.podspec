#
# Be sure to run `pod lib lint WYPodTwo.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  s.name             = 'WYPodTwo'
  s.version          = '0.1.0'
  s.summary          = 'A short description of WYPodTwo.'
...
TODO: Add long description of the pod here.
  ...
  s.source_files = 'WYPodTwo/Classes/**/*'
  
  # s.resource_bundles = {
  #   'WYPodTwo' => ['WYPodTwo/Assets/*.png']
  # }
